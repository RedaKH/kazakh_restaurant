 ...
 */
final class Version20240903142137 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD CONSTRAINT FK_C0155143F675F31B FOREIGN KEY (author_id) REFERENCES employe (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
