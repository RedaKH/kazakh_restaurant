 ...
 */
final class Version20240912084952 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955F8646701 FOREIGN KEY (livreur_id) REFERENCES employe (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
